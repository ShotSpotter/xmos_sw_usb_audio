# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 290 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c" 2
...
# 2 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c" 2
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 1 3
# 34 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
typedef enum {
  PROT_TYPE_NONE=0,
  PROT_TYPE_SR=1,
  PROT_TYPE_SECS=2,
...
# 154 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_connect(fl_SPIPorts* SPI);
# 171 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_connectToDevice(fl_SPIPorts *SPI, const fl_DeviceSpec spec[], unsigned n);
# 181 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_dividerOverride(int div);
# 191 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_getFlashType();
...
# 207 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
unsigned fl_getSpiId(fl_SPIPorts * SPI, unsigned id_command);
# 217 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
...
# 239 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
...
# 272 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_getNextBootImage(fl_BootImageInfo* bootImageInfo);
# 283 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
unsigned fl_getImageVersion(fl_BootImageInfo* bootImageInfo);
# 302 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_startImageAdd(fl_BootImageInfo *bootImageInfo, unsigned maxsize,
                     unsigned padding);
# 322 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_startImageAddAt( unsigned offset, unsigned maxsize);
# 340 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_startImageReplace(fl_BootImageInfo *bootImageInfo, unsigned maxsize);
# 352 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
...
# 378 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_startDeleteImage(fl_BootImageInfo *bootImageInfo);
# 388 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_startImageRead(fl_BootImageInfo *bootImageInfo);
# 398 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
...
# 419 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
unsigned fl_getDataPartitionSize(void);
# 429 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
int fl_readData(unsigned offset, unsigned size, unsigned char dst[]);
# 438 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
unsigned fl_getWriteScratchSize(unsigned offset, unsigned size);
# 450 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
...
# 474 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 3
...
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/SpecEnum.h" 1 3
...
# 517 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 2 3




# 1 "/Applications/XMOS_XTC_15.1.4/target/include/SpecMacros.h" 1 3
# 522 "/Applications/XMOS_XTC_15.1.4/target/include/flash.h" 2 3
# 3 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c" 2
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/flashlib.h" 1 3
# 26 "/Applications/XMOS_XTC_15.1.4/target/include/flashlib.h" 3
...
# 95 "/Applications/XMOS_XTC_15.1.4/target/include/flashlib.h" 3
unsigned int fl_setBootPartitionSize( unsigned int s );
unsigned int fl_getBootPartitionSize();


unsigned fl_getDataPartitionBase();
# 111 "/Applications/XMOS_XTC_15.1.4/target/include/flashlib.h" 3
...
# 4 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c" 2
...
# 5 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c" 2
...
int clz(unsigned x);
# 6 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_dfu/src/flash_interface.c" 2
