	.text
	.file	"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc"
	...
	.set usage.anon.5,0
	.set usage.anon.6,0
	.globread device_reboot_aux,tile,"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:43:30: note: object used here\n        tileId = get_tile_id(tile[i]);\n                             ^~~~~~~"
	...
	.globpassesref get_tile_id, tile,"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:43:18: error: call to `get_tile_id\' in `device_reboot_aux\' makes alias of global \'tile\'\n        tileId = get_tile_id(tile[i]);\n                 ^~~~~~~~~~~~~~~~~~~~"
...
.Lfunc_begin0:
	.file	2 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc"
	.loc	2 21 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:21:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp1:
	.cfi_offset 15, 0
	.loc	2 32 0 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:32:0
.Ltmp2:
...
.Ltmp10:
	...
	.loc	2 37 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:37:0
	#APP
...
.Lxtalabel1:
	.loc	2 43 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:43:0
.Ltmp13:
	{
		lsu r0, r10, r9
		nop
...
.Ltmp14:
	...
	.loc	2 46 9                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:46:9
	{
		eq r0, r4, r7
		nop
	}
...
.Lxtalabel2:
	...
	.loc	2 48 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:48:0
	{
		mov r0, r7
		mov r1, r5
	}
...
.Lxta.call_labels2:
	...
	.loc	2 49 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:49:0
	{
		and r2, r0, r6
		nop
	}
.Ltmp16:
	...
	.loc	2 50 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:50:0
	{
		mov r1, r5
		nop
	}
...
.LBB0_4:                                # %LoopIncrement
                                        #   in Loop: Header=BB0_2 Depth=1
.Lxtalabel3:
	.loc	2 40 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:40:0
	{
		add r9, r9, 1
		nop
	}
...
.Ltmp20:
	.loc	2 55 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:55:0
	{
		mov r0, r4
		mov r1, r5
	}
...
.Ltmp21:
	#DEBUG_VALUE: pllVal <- R2
	.loc	2 56 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:56:0
	{
		and r2, r0, r1
		mov r0, r4
	}
.Ltmp22:
	.loc	2 57 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:57:0
	{
		mov r1, r5
		nop
	}
...
.Lfunc_begin1:
	.loc	2 63 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:63:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel5:
...
.Ltmp27:
	...
	.loc	2 71 0 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:71:0
.Ltmp28:
.Lxta.call_labels6:
...
.LBB1_1:                                # %LoopTest
                                        # =>This Inner Loop Header: Depth=1
	#DEBUG_VALUE: device_reboot:spare <- R0
	.loc	2 73 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:73:5
	bu .LBB1_1
.Ltmp30:
...
.Linfo_string1:
.asciiz"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc"
.Linfo_string2:
...
.cc_top cc_0,.Lxta.call_labels0
	.ascii	"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc"
	.byte	0
	.long	32
...
.Ltrap_info_str0:
.asciiz"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/reboot.xc:43:30: error: out of bounds array access\n        tileId = get_tile_id(tile[i]);\n                             ^~~~~~~\n"
	.section	.trap_info,"",@progbits
