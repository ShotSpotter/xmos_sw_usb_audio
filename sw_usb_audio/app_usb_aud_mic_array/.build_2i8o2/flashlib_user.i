# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 290 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c" 2
...
# 2 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c" 2
...
# 6 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/uac_hwresources.h" 2
# 3 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c" 2
...
int clz(unsigned x);
# 8 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c" 2

# 1 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 1 3
# 19 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 3
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 1 3
# 34 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
typedef enum {
  PROT_TYPE_NONE=0,
  PROT_TYPE_SR=1,
  PROT_TYPE_SECS=2,
...
# 152 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_connect(fl_QSPIPorts* QSPI);
# 169 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_connectToDevice(fl_QSPIPorts *QSPI, const fl_QuadDeviceSpec spec[], unsigned n);
# 179 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_dividerOverride(int div);
# 189 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_getFlashType();
...
# 205 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
void fl_getSpiId(fl_QSPIPorts * QSPI, unsigned id_command, unsigned char destination[]);
# 215 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
...
# 239 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
...
# 272 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_getNextBootImage(fl_BootImageInfo* bootImageInfo);
# 283 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
unsigned fl_getImageVersion(fl_BootImageInfo* bootImageInfo);
# 302 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_startImageAdd(fl_BootImageInfo *bootImageInfo, unsigned maxsize,
                     unsigned padding);
# 322 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_startImageAddAt( unsigned offset, unsigned maxsize);
# 340 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_startImageReplace(fl_BootImageInfo *bootImageInfo, unsigned maxsize);
# 352 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
...
# 378 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_startDeleteImage(fl_BootImageInfo *bootImageInfo);
# 388 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_startImageRead(fl_BootImageInfo *bootImageInfo);
# 398 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
...
# 419 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
unsigned fl_getDataPartitionSize(void);
# 429 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
int fl_readData(unsigned offset, unsigned size, unsigned char dst[]);
# 438 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
unsigned fl_getWriteScratchSize(unsigned offset, unsigned size);
# 450 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
...
# 474 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 3
...
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/QuadSpecEnum.h" 1 3
...
# 517 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 2 3




# 1 "/Applications/XMOS_XTC_15.1.4/target/include/QuadSpecMacros.h" 1 3
# 522 "/Applications/XMOS_XTC_15.1.4/target/include/quadflash.h" 2 3
# 20 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 2 3
...
# 58 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 3
...
# 80 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 3
...
# 96 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 3
unsigned int fl_setBootPartitionSize( unsigned int s );
unsigned int fl_getBootPartitionSize();


unsigned fl_getDataPartitionBase();
# 112 "/Applications/XMOS_XTC_15.1.4/target/include/quadflashlib.h" 3
...
# 10 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c" 2
# 35 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c"
...
# 54 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c"
int flash_cmd_enable_ports()
{
    int result = 0;
# 90 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c"
...
{
    fl_disconnect();
# 117 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/flashlib_user.c"
    return 1;
}
