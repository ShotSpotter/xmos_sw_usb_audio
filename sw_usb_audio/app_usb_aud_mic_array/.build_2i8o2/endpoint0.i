...
# 53 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/descriptors.h"
...
# 318 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/descriptors.h"
...
# 401 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/descriptors.h"
...
# 478 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/descriptors.h"
...
# 1625 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_In_Endpoint =
    {
        ...
        .wMaxPacketSize = ((((((48000)+7999)/8000)+1) * (8)) * 4),
        .bInterval = 0x01,
    },
...
# 491 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
            ...
            {
# 538 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
                        }
           ...
           asm ("chkct res[%0], %1" :: "r" (c_audioControl), "r" (0x1));
                        ...
                        {
# 605 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
...
# 621 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
        ...
        if(result == XUD_RES_ERR)
        {
            ...
            if (!DFU_mode_active)
            {
# 650 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
                if(g_curUsbSpeed == XUD_SPEED_HS)
                {
                    ...
                    cfgDesc_Audio2.Audio_Out_Endpoint.wMaxPacketSize = ((((((48000)+7999)/8000)+1) * (2)) * 4);
                    ...
                    cfgDesc_Audio2.Audio_Out_Endpoint_2.wMaxPacketSize = ((((((48000)+7999)/8000)+1) * (2)) * (16/8));
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface_2.bNrChannels = (2);
# 676 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
                    cfgDesc_Audio2.Audio_CS_Control_Int.Audio_In_InputTerminal.bNrChannels = (8);
                    cfgDesc_Audio2.Audio_In_Format.bSubslotSize = 4;
                    cfgDesc_Audio2.Audio_In_Format.bBitResolution = 24;
                    cfgDesc_Audio2.Audio_In_Endpoint.wMaxPacketSize = ((((((48000)+7999)/8000)+1) * (8)) * 4);
                    cfgDesc_Audio2.Audio_In_ClassStreamInterface.bNrChannels = (8);
                ...
                else
                {
                    ...
                    cfgDesc_Audio2.Audio_Out_Format.bBitResolution = 24;
                    cfgDesc_Audio2.Audio_Out_Endpoint.wMaxPacketSize = ((((((44100)+999)/1000)+1) * ((2))) * (24/8));
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface.bNrChannels = ((2));


                    cfgDesc_Audio2.Audio_Out_Format_2.bSubslotSize = (16/8);
                    cfgDesc_Audio2.Audio_Out_Format_2.bBitResolution = 16;
                    cfgDesc_Audio2.Audio_Out_Endpoint_2.wMaxPacketSize = ((((((44100)+999)/1000)+1) * ((2))) * (16/8));
                    cfgDesc_Audio2.Audio_Out_ClassStreamInterface_2.bNrChannels = ((2));
# 709 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/endpoint0.c"
                    cfgDesc_Audio2.Audio_CS_Control_Int.Audio_In_InputTerminal.bNrChannels = (2);
                    cfgDesc_Audio2.Audio_In_Format.bSubslotSize = (24/8);
                    cfgDesc_Audio2.Audio_In_Format.bBitResolution = 24;
                    cfgDesc_Audio2.Audio_In_Endpoint.wMaxPacketSize = ((((((44100)+999)/1000)+1) * (2)) * (24/8));
