# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc" 2
...
# 3 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc" 2
...
# 4 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc" 2
...
# 5 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc" 2
...
# 7 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc" 2
...
# 8 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc" 2
# 24 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
...
# 200 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
...
void clockGen (streaming chanend ?c_spdif_rx, chanend ?c_adat_rx, out port p, chanend c_dig_rx, chanend c_clk_ctl, chanend c_clk_int)
{
    ...
    int smux = 0;
# 254 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
    for(int i = 0; i < 10; i++)
    {
       g_digData[i] = 0;
    }
# 266 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
    clockFreq[(1 - 1)] = 0;
    clockId[(1 - 1)] = 41;
    clockValid[(1 - 1)] = 0;
    clockInt[(1 - 1)] = 0;
# 295 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
    t_local :> timeNextEdge;
    timeLastEdge = timeNextEdge;
    timeNextClockDetection = timeNextEdge + (166667 / 2);
    timeNextEdge += 166667;
# 311 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
    p <: pinVal @ pinTime;
    ...
    while(1)
    {
        select
        {
# 357 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
...
# 396 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
                        break;
       ...
       break;
            ...
            case t_local when __builtin_timer_after(timeNextEdge) :> void:
                ...
                timeNextClockDetection = timeNextEdge + (166667/2);
                timeNextEdge += 166667;
# 472 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
                break;
# 824 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/clocking/clockgen.xc"
        }
