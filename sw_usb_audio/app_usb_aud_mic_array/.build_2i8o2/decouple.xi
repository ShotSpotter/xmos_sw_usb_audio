# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 2 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 3 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 4 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/interrupt.h" 1
# 5 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 6 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 7 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc" 2
# 32 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
unsigned int multOut[(2) + 1];
static xc_ptr p_multOut;


unsigned int multIn[(8) + 1];
static xc_ptr p_multIn;



unsigned g_numUsbChan_Out = (2);
unsigned g_numUsbChan_In = (8);
# 54 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
unsigned outAudioBuff[((4 * (((((48000)+7999)/8000))+3) * (2))>(4 * (((((44100)+999)/1000))+3) * ((2))) ? (4 * (((((48000)+7999)/8000))+3) * (2)) : (4 * (((((44100)+999)/1000))+3) * ((2)))) + (1028>>2) + 4];
unsigned audioBuffIn[((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * (2)) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * (2))) + (((((((44100)/1000+1)*(2)*4))>((((48000)/8000+1)*(8)*4)) ? ((((44100)/1000+1)*(2)*4)) : ((((48000)/8000+1)*(8)*4))))>>2) + 4];

unsigned inZeroBuff[(((((((44100)/1000+1)*(2)*4))>((((48000)/8000+1)*(8)*4)) ? ((((44100)/1000+1)*(2)*4)) : ((((48000)/8000+1)*(8)*4))))>>2)+4];
...
int sampsToWrite = ((11025))/8000;
int totalSampsToWrite = ((11025))/8000;
...
int g_maxPacketSize = (((48000)/8000+1)*(8)*4);
...
#pragma xta endpoint "out_underflow"
 ...
 for(int i = 0; i < (2); i++)
        ...
        if (outSamps < 0)
        {
            outSamps += ((4 * (((((48000)+7999)/8000))+3) * (2))>(4 * (((((44100)+999)/1000))+3) * ((2))) ? (4 * (((((48000)+7999)/8000))+3) * (2)) : (4 * (((((44100)+999)/1000))+3) * ((2))))*4;
        }


        if(outSamps >= ((((((2))*(((((44100)+999)/1000))+3)*3+4)>((2)*(((((48000)+7999)/8000))+3)*4+4) ? (((2))*(((((44100)+999)/1000))+3)*3+4) : ((2)*(((((48000)+7999)/8000))+3)*4+4))*1)))
        {
            outUnderflow = 0;
            outSamps++;
        }
...
__builtin_unreachable();
            ...
            case 4:
            {
                ...
                for(int i = 0; i < g_numUsbChan_In; i++)
                {
                    ...
                    {h, l} = __builtin_macs(mult, sample, 0, 0);
                    sample = h << 3;
# 354 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
        ...
        for(int i = 0; i < (8) - g_numUsbChan_In; i++)
        {
...

    {
        ...
        if (sampsToWrite <= 0)
        {
            ...
            speedRem &= 0xffff;
# 470 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
            ...
            if((space_left < (totalSampsToWrite * g_numUsbChan_In * g_curSubSlot_In + 4)))
            {
                ...
                } while(space_left < (((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * (2)) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * (2)))*4/2));
            }
...
)
{
    ...
    aud_from_host_fifo_end = aud_from_host_fifo_start + ((4 * (((((48000)+7999)/8000))+3) * (2))>(4 * (((((44100)+999)/1000))+3) * ((2))) ? (4 * (((((48000)+7999)/8000))+3) * (2)) : (4 * (((((44100)+999)/1000))+3) * ((2))))*4;
    ...
    aud_to_host_fifo_end = aud_to_host_fifo_start + ((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * (2)) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * (2)))*4;
    g_aud_to_host_wrptr = aud_to_host_fifo_start;
    ...
    {
        int tmp;
# 684 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
        {
            ...
            else if(tmp == 9)
            {
                ...
                {
                    g_maxPacketSize = ((((44100)/1000+1)*4) * g_numUsbChan_In);
                }
...
# 810 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
                __builtin_in_uint(c_mix_out);
        ...
        else if (outOverflow)
        {
            ...
            space_left = aud_from_host_rdptr - aud_from_host_wrptr;
            if (space_left <= 0)
                space_left += ((4 * (((((48000)+7999)/8000))+3) * (2))>(4 * (((((44100)+999)/1000))+3) * ((2))) ? (4 * (((((48000)+7999)/8000))+3) * (2)) : (4 * (((((44100)+999)/1000))+3) * ((2))))*4;
            if (space_left >= (((4 * (((((48000)+7999)/8000))+3) * (2))>(4 * (((((44100)+999)/1000))+3) * ((2))) ? (4 * (((((48000)+7999)/8000))+3) * (2)) : (4 * (((((44100)+999)/1000))+3) * ((2))))*4/2))
            {
...

        {
            ...
            if (tmp)
            {
                ...
                if (inUnderflow)
                {
                    ...
                    if (fill_level < 0)
                        fill_level += ((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * (2)) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * (2)))*4;

                    if (fill_level >= ((((((((44100)+999)/1000))+3)*2+4)>((((((48000)+7999)/8000))+3)*4+4) ? ((((((44100)+999)/1000))+3)*2+4) : ((((((48000)+7999)/8000))+3)*4+4))*2))
                    {
                        inUnderflow = 0;
