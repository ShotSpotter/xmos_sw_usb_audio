	.text
	.file	"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.xc"
...
.Lfunc_begin0:
	.file	1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h"
	.loc	1 15 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:15:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
# BB#1:                                 # %lhsfalse
	#DEBUG_VALUE: is_power_of_2:x <- R0
	.loc	1 16 5 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:16:5
	{
		sub r1, r0, 1
		nop
	}
	.loc	1 16 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:16:5
	{
		and r0, r1, r0
		nop
	}
...
.Lfunc_begin1:
	.loc	1 19 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:19:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel1:
...
.LBB1_5:                                # %is_power_of_2.exit
	#DEBUG_VALUE: queue_init:q <- R0
	#DEBUG_VALUE: queue_init:size <- R1
	.loc	1 20 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:20:0
	#APP
	ecallf r3
	#NO_APP
	{
...
.Lfunc_begin2:
	.loc	1 27 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:27:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel2:
...
.Ltmp8:
	.loc	1 28 5 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:28:5
	{
		eq r0, r1, r0
		retsp 0
	}
...
.Lfunc_begin3:
	.loc	1 31 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:31:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel3:
	...
	.loc	1 32 5 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:32:5
.Ltmp11:
	{
		sub r1, r1, r2
		ldw r0, r0[2]
...
.Ltmp12:
	.loc	1 32 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:32:5
	{
		eq r0, r1, r0
		retsp 0
	}
...
.Lfunc_begin4:
	.loc	1 36 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:36:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel4:
...
.Ltmp20:
	.loc	1 37 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:37:0
	{
		eq r4, r4, r5
		nop
	}
	...
	ecallf r4
	#NO_APP
	.loc	1 38 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:38:0
	{
		add r4, r11, 1
		nop
	}
...
.Lfunc_begin5:
	.loc	1 41 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:41:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel5:
...
.Ltmp24:
	...
	.loc	1 42 0 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:42:0
.Ltmp25:
	{
		eq r3, r3, r11
		nop
	...
	.loc	1 42 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:42:0
	#APP
	ecallf r3
	#NO_APP
	.loc	1 43 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:43:5
	{
		add r3, r11, 1
		nop
	}
...
.Lfunc_begin6:
	.loc	1 47 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:47:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel6:
...
.Ltmp34:
	.loc	1 48 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:48:0
	{
		eq r4, r4, r5
		nop
	}
	...
	ecallf r4
	#NO_APP
	.loc	1 49 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:49:0
	{
		add r4, r11, 1
		nop
	}
...
.Lfunc_begin7:
	.loc	1 52 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:52:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel7:
...
.Ltmp38:
	...
	.loc	1 53 0 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:53:0
.Ltmp39:
	{
		eq r3, r3, r11
		nop
	...
	.loc	1 53 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:53:0
	#APP
	ecallf r3
	#NO_APP
	.loc	1 54 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:54:5
	{
		add r3, r11, 1
		nop
	}
...
.Lfunc_begin8:
	.loc	1 57 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:57:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel8:
...
.Ltmp43:
	.loc	1 58 5 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:58:5
	{
		sub r0, r1, r0
		retsp 0
	}
...
.Lfunc_begin9:
	.loc	1 61 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:61:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel9:
...
.Ltmp48:
	.loc	1 62 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:62:5
	{
		add r0, r1, r0
		retsp 0
	}
...
.Linfo_string1:
.asciiz"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.xc"
.Linfo_string2:
...
.Ltrap_info_str0:
.asciiz"In file included from /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.xc:1:\n/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:38:5: error: out of bounds array access\n    array[q.wrptr++ & q.mask] = data;\n    ^~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_0
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str1:
.asciiz"In file included from /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.xc:1:\n/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:43:12: error: out of bounds array access\n    return array[q.rdptr++ & q.mask];\n           ^~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_1
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str2:
.asciiz"In file included from /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.xc:1:\n/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:49:5: error: out of bounds array access\n    array[q.wrptr++ & q.mask] = data;\n    ^~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
...
.cc_bottom cc_trapinfo_2
	.section	.trap_info_str,"MS",@progbits
.Ltrap_info_str3:
.asciiz"In file included from /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.xc:1:\n/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_queue/src/queue.h:54:12: error: out of bounds array access\n    return array[q.rdptr++ & q.mask];\n           ^~~~~~~~~~~~~~~~~~~~~~~~~\n"
	.section	.trap_info,"",@progbits
