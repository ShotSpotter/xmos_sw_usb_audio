# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
# 3 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
# 9 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
# 11 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
# 12 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/xc/string.h" 1 3



# 1 "/Applications/XMOS_XTC_15.1.4/target/include/string.h" 1 3
# 15 "/Applications/XMOS_XTC_15.1.4/target/include/string.h" 3
# 1 "/Applications/XMOS_XTC_15.1.4/target/include/clang/stddef.h" 1 3
...
# 13 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
int clz(unsigned x);
# 14 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
# 15 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
void mic_array_decimator_configure(
        ...
        mic_array_decimator_config_t dc[]);
# 17 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/pdm_mics/pcm_pdm_mic.xc" 2
...
int data_0[4*(32) * 12] = {0};
int data_1[4*(32) * 12] = {0};
...
void pdm_process(streaming chanend c_ds_output[2], chanend c_audio)
{
    ...
    while(1)
    {
        ...
        unsafe
        {
            ...
            mic_array_decimator_conf_common_t dcc = {0, 1, 0, 0, decimationfactor, fir_coefs[decimationfactor/2], 0, 0, DECIMATOR_NO_FRAME_OVERLAP, 2};
