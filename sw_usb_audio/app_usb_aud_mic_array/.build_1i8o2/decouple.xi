...
unsigned audioBuffIn[((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * 8) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * 8)) + (((((((44100)/1000+1)*8*4))>((((48000)/8000+1)*(8)*4)) ? ((((44100)/1000+1)*8*4)) : ((((48000)/8000+1)*(8)*4))))>>2) + 4];

unsigned inZeroBuff[(((((((44100)/1000+1)*8*4))>((((48000)/8000+1)*(8)*4)) ? ((((44100)/1000+1)*8*4)) : ((((48000)/8000+1)*(8)*4))))>>2)+4];
...
int sampsToWrite = ((8000))/8000;
int totalSampsToWrite = ((8000))/8000;
...
int g_maxPacketSize = (((44100)/1000+1)*8*4);
...
# 470 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/usb_buffer/decouple.xc"
            ...
            if((space_left < (totalSampsToWrite * g_numUsbChan_In * g_curSubSlot_In + 4)))
            {
                ...
                } while(space_left < (((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * 8) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * 8))*4/2));
            }
...
)
{
    ...
    aud_to_host_fifo_end = aud_to_host_fifo_start + ((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * 8) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * 8))*4;
    g_aud_to_host_wrptr = aud_to_host_fifo_start;
...

        {
            ...
            if (tmp)
            {
                ...
                if (inUnderflow)
                {
                    ...
                    if (fill_level < 0)
                        fill_level += ((4 * (((((48000)+7999)/8000))+3) * (8))>(4 * (((((44100)+999)/1000))+3) * 8) ? (4 * (((((48000)+7999)/8000))+3) * (8)) : (4 * (((((44100)+999)/1000))+3) * 8))*4;
