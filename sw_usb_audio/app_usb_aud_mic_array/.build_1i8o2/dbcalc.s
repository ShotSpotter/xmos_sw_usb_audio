	.text
	.file	"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc"
	...
	.set usage.anon.2,0
	.set usage.anon.3,0
	.globread db_to_mult,usage.anon.3,"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:87:14: note: object used here\n      val += coef[i] >> (COEF_PREC - DB_CALC_PREC);\n             ^~~~~~~"
...
.Ldebug_range:
	.file	1 "/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc"
...
.Lfunc_begin0:
	.loc	1 32 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:32:0
	.cfi_startproc
	.issue_mode dual
# BB#0:                                 # %allocas
.Lxtalabel0:
...
.Ltmp6:
	...
	.loc	1 40 3 prologue_end     # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:40:3
	bf r0, .LBB0_1
.Ltmp7:
# BB#2:                                 # %ifdone
.Lxtalabel1:
	...
	.loc	1 46 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:46:0
	{
		sub r1, r3, r1
		nop
	}
...
.Ltmp9:
	...
	.loc	1 47 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:47:0
	{
		mov r3, r0
		mov r4, r0
	}
...
.Ltmp11:
	#DEBUG_VALUE: db_to_mult:db <- R1
	.loc	1 48 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:48:0
	{
		shl r3, r1, 4
		nop
	}
.Ltmp12:
	...
	.loc	1 55 3                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:55:3
	ashr r1, r3, 32
	bt r1, .LBB0_3
.Ltmp13:
# BB#11:                                # %iffalse
...
.Ltmp14:
	#DEBUG_VALUE: db_to_mult:db <- R1
	.loc	1 68 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:68:0
	{
		and r1, r3, r1
		ldc r11, 28
	}
.Ltmp15:
	.loc	1 69 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:69:0
	ashr r11, r3, r11
.Ltmp16:
...
.Lxtalabel3:
	...
	.loc	1 72 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:72:0
.Ltmp18:
	{
		lss r4, r11, r4
		nop
...
.Lxtalabel4:
	#DEBUG_VALUE: db_to_mult:db <- R1
	#DEBUG_VALUE: db_to_mult:result_frac_bits <- R2
	.loc	1 73 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:73:0
	mul r3, r3, r4
	.loc	1 72 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:72:0
	{
		sub r11, r11, 1
...
.Lxtalabel5:
	...
	.loc	1 41 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:41:5
	{
		shl r0, r0, r2
		nop
	}
...
.Ltmp22:
	...
	#DEBUG_VALUE: val0 <- 0
	#DEBUG_VALUE: mask <- -268435456
	.loc	1 56 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:56:0
	{
		neg r5, r3
		nop
	}
...
.Ltmp23:
	...
	#DEBUG_VALUE: db_to_mult:db <- R1
	.loc	1 57 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:57:0
	{
		add r1, r1, r3
		ldc r3, 28
	}
.Ltmp24:
	.loc	1 58 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:58:0
	ashr r5, r5, r3
.Ltmp25:
	#DEBUG_VALUE: intpart <- R5
	.loc	1 60 5                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:60:5
	bf r5, .LBB0_4
.Ltmp26:
# BB#15:                                # %iftrue20
.Lxtalabel7:
	...
	.loc	1 62 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:62:0
.Ltmp27:
	{
		lss r6, r5, r6
		nop
...
.Lxtalabel8:
	#DEBUG_VALUE: db_to_mult:db <- R1
	#DEBUG_VALUE: db_to_mult:result_frac_bits <- R2
	.loc	1 63 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:63:0
	{
		mov r7, r6
		mov r8, r6
	}
...
.Ltmp32:
	#DEBUG_VALUE: hi <- 0
	#DEBUG_VALUE: lo <- 0
	.loc	1 84 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:84:0
	{
		mov r7, r0
		mov r8, r0
	}
	...
	maccs r8, r7, r1, r11
	#NO_APP
	.loc	1 86 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:86:0
	{
		shl r11, r8, 4
		shr r7, r7, r4
	}
...
.Ltmp34:
	#DEBUG_VALUE: i <- R6
	.loc	1 87 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:87:0
	{
		add r11, r11, r7
		add r6, r6, 1
	}
.Ltmp35:
	.loc	1 79 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:79:0
	{
		lss r7, r6, r5
		nop
	}
...
.Ltmp38:
	...
	.loc	1 95 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:95:0
.Ltmp39:
	{
		mov r1, r0
		nop
...
.Ltmp40:
	#DEBUG_VALUE: lo <- 0
	#DEBUG_VALUE: hi <- 0
	.loc	1 96 0                  # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:96:0
	{
		shl r0, r0, 4
		shr r1, r1, r4
	}
...
.Lxtalabel13:
	...
	.loc	1 103 3                 # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:103:3
	{
		lss r0, r2, r0
		nop
	}
...
.Lxtalabel14:
	...
	#DEBUG_VALUE: val0 <- 0
	#DEBUG_VALUE: mask <- -268435456
	.loc	1 104 5                 # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:104:5
	ldaw r0, r2[-7]
	.loc	1 104 5                 # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:104:5
	{
		shl r0, r11, r0
...
.Ltmp42:
	#DEBUG_VALUE: ret <- R11
	.loc	1 107 5                 # /Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc:107:5
	{
		sub r0, r4, r2
		nop
	}
...
.Linfo_string1:
.asciiz"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc"
.Linfo_string2:
...
.cc_top cc_0,.Lxtalabel0
	.ascii	"/Users/rcalhoun/code/git/sw_usb_audio/sc_usb_audio/module_usb_audio/endpoint0/dbcalc.xc"
	.byte	0
	.long	32
	.long	37
	.long	.Lxtalabel0
