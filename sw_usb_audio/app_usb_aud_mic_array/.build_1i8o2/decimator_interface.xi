# 1 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc" 2
...
void mic_array_decimator_configure(
        ...
        mic_array_decimator_config_t dc[]);
# 2 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc" 2
...
# 3 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc" 2
...
# 4 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc" 2
...
# 72 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc"
     for(unsigned i=0;i<decimator_count;i++)
         __builtin_schkct(c_from_decimator[i], 8);
...
mic_array_frame_fft_preprocessed * alias mic_array_get_next_frequency_domain_frame(
     ...
     unsigned &buffer, mic_array_frame_fft_preprocessed * alias f_fft_preprocessed,
     mic_array_decimator_config_t dc[]){
# 165 "/Users/rcalhoun/code/git/sw_usb_audio/lib_mic_array/lib_mic_array/src/decimator_interface.xc"
     for(unsigned i=0;i<decimator_count;i++)
         __builtin_schkct(c_from_decimator[i], 8);
